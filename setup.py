...
# Package meta-data.
NAME = 'scdart'
DESCRIPTION = 'scdart, learning latent embedding of multi-modalsingle cell data and cross-modality relationship simultaneously'
URL = 'https://github.com/PeterZZQ/scDART.git'
EMAIL = 'zhangziqibuaa@gmail.edu'
AUTHOR = 'Ziqi Zhang, Chengkai Yang'
